...
public interface TestConstantsAndCommonCode {
    ...
    String BASE64_ENCODED_EMAIL_ADDRESS = "aGF5c3RhY2tAZXhwZWRpYS5jb20=";
    ...
    String JSON_SPAN_STRING_WITH_EMAIL_ADDRESS_IN_LOG_TAG = JSON_SPAN_STRING
            .replace(STRING_FIELD_VALUE, EMAIL_ADDRESS);
    String JSON_SPAN_STRING_WITH_EMAIL_ADDRESS_IN_LOG_TAG_AND_VBYTES = JSON_SPAN_STRING_WITH_EMAIL_ADDRESS_IN_LOG_TAG
            .replace(BASE_64_ENCODED_STRING, BASE64_ENCODED_EMAIL_ADDRESS);
    Span EMAIL_ADDRESS_LOG_SPAN = buildSpan(JSON_SPAN_STRING_WITH_EMAIL_ADDRESS_IN_LOG_TAG);
    Span EMAIL_ADDRESS_LOG_SPAN_TAG_AND_VBYTES = buildSpan(JSON_SPAN_STRING_WITH_EMAIL_ADDRESS_IN_LOG_TAG_AND_VBYTES);
